...
@Service
public class ValidadorTelefonoServiceImpl implements ValidadorTelefonoService {
    ...
    private boolean verificarCaracteres(String telefono) {
    ...
    private boolean verificaDiezDigitos(String telefono){
